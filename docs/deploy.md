...
- 当日その部屋を見る人が `/admin/help` に目を通しているか。合言葉と有効時間は
  **部屋を作ったあとから変えられない**ので、ここだけは作る前に決めておく
...
子どもへの説明は `/help` にある。読める学年なら先に開いてもらい、そうでなければ大人が
声で説明する。部屋に入っていなくても開けるので、URLだけ先に渡しておいてもよい。
